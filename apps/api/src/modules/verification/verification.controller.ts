...
export class DriverVerificationController {
  ...
  @Post('submissions') @UseInterceptors(FileFieldsInterceptor(fields, { limits: { fileSize: 5 * 1024 * 1024, files: 3 } }))
...
export class AdminVerificationController {
  ...
  @Post('drivers/:driverId/submissions') @UseInterceptors(FileFieldsInterceptor(fields, { limits: { fileSize: 5 * 1024 * 1024, files: 3 } }))
